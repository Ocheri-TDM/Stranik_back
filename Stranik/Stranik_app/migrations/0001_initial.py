    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='rent/', verbose_name='Фотография')),
                ('cost_value', models.IntegerField(blank=True, null=True, verbose_name='Цена (числовое значение)')),
